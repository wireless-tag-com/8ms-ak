...
/*
 * 屏幕旋转角度。根据旋转角度开启相应的宏。不旋转时都为0。最多只能打开一个！！！
 * 旋转后，需要设置上方的分辨率，分辨率参数为旋转后的宽度和长度。
 */
#define USE_LCD_ROTATE_90       0       /*逆时针旋转 90 度*/
#define USE_LCD_ROTATE_180      0       /*逆时针旋转 180 度*/
#define USE_LCD_ROTATE_270      0       /*逆时针旋转 270 度*/
...
#define LV_DISP_DEF_REFR_PERIOD      20      /*[ms]*/   //显示刷新周期 30
...
#define LV_DISP_ROT_MAX_BUF  (10U * 1024U)      /*分配轮转 缓冲区大小*/
...
#define LV_INDEV_DEF_READ_PERIOD          10  //输入设备的扫描时间 30

/* Drag threshold in pixels */
#define LV_INDEV_DEF_DRAG_LIMIT           10  //拖拽动作像素阀值 10

/* Drag throw slow-down in [%]. Greater value -> faster slow-down */
#define LV_INDEV_DEF_DRAG_THROW           10  // 拖拽动作停止减速效果 10

/* Long press time in milliseconds.
 * Time to send `LV_EVENT_LONG_PRESSED`) */
#define LV_INDEV_DEF_LONG_PRESS_TIME      400  //长按时间阀值，长按超过这个时间会发送 LV_EVENT_LONG_PRESS  400

/* Repeated trigger period in long press [ms]
 * Time between `LV_EVENT_LONG_PRESSED_REPEAT */
#define LV_INDEV_DEF_LONG_PRESS_REP_TIME  100 // 长按模式下重复触发时间阀值 100

/* Gesture threshold in pixels */
#define LV_INDEV_DEF_GESTURE_LIMIT        50 //手势动作像素阀值 50

/* Gesture min velocity at release before swipe (pixels)*/
#define LV_INDEV_DEF_GESTURE_MIN_VELOCITY 3   // 滑动前释放时的手势最小速度 3
...
#define LV_USE_PERF_MONITOR     0     // 显示 CPU 和 FPS 
