...
typedef struct _disp_drv_t {
    ...
    /* 修改 gpu_blend_cb，增加两个参数，area 和 color，以支持 tde 硬件加速*/
    void (*gpu_blend_cb)(struct _disp_drv_t * disp_drv, lv_color_t * dest, const lv_color_t * src, uint32_t length, lv_opa_t opa, lv_area_t * area, lv_color_t color);
    ...
    /* new */
    void (*draw_video_cb)(struct _disp_drv_t * disp_drv, lv_color_t * dest, const lv_color_t * src, lv_area_t * area);
#endif
